  ...
  return (
    <>
      ...
      <main style={{ maxWidth: 720, margin: "0 auto", padding: "64px 32px" }}>
        <h1 style={{ fontSize: 32, fontWeight: 700, color: "var(--navy)", marginBottom: 24, letterSpacing: "-0.02em" }}>Terms of Service</h1>
        ...
        <p style={{ fontSize: 16, lineHeight: 1.7, color: "var(--text-2)" }}>
          Questions? Email <a href="mailto:hello@patch.london" style={{ color: "var(--navy)", fontWeight: 500 }}>hello@patch.london</a>.
        </p>
      </main>
    </>
  );
